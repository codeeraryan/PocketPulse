...
const Auth = ({navigation}) => {
 ...
 <Pressable style={{top:insets.top}} onPress={()=>navigation.goBack()} ><View style={tailwind`p-2 w-12 ml-4 mt-2 bg-[#c7ea46] items-center justify-center rounded-full`}><ChevronLeft color={'white'} size={30}/></View></Pressable>
